...
import { findPostsByParkId, findPostsByFollowing } from '../services/posts-service';
...
const Feed = () => {
    ...
    return (
        <div className = "w-100">
            ...
            {currentUser && currentUser.role === 'rangers' &&
            <>
                <h4 className = "brown-4 m-2 fst-italic">My Park</h4>
                <PostsList postFunction={() => findPostsByParkId(currentUser.parkId)} />
            </>}
